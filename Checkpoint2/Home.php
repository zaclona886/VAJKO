...
<div class="container">
    <header class="d-flex justify-content-center py-3">
        <ul class="nav nav-pills">
            ...
            <li class="nav-item"><a href="Jutsus.php" class="nav-link">Jutsus</a></li>
        </ul>
    </header>
</div>
        ...
        <div class="col-12 col-md-8">
            <div class="row ">
                <img class="napisNaruto"
                     src="https://upload.wikimedia.org/wikipedia/commons/thumb/c/c9/Naruto_logo.svg/1920px-Naruto_logo.svg.png" alt="...">
            </div>
            <div class="mytext border border-3 border-dark rounded">
                ...
                <div class="row">
                    <div class="col-sm-6 col-xs-12 col-md-12">
                        ...
                        Third Hokage returns from retirement to become the leader of Konoha again. Naruto is often scorned by
                        Konoha's villagers for being the host of the Nine-Tails. Due to a decree by the Third Hokage forbidding
                        any mention of these events, Naruto learns nothing about the Nine-Tails until 12 years later, when
                        Mizuki, a renegade ninja, reveals the truth to Naruto. Naruto then defeats Mizuki in combat,earning the
                        respect of his teacher, Iruka Umino.
                        </p>
                    </div>
                    <div class="col-sm-6 col-xs-12 ">
                        <img class="mobil border border-5 border-dark rounded img-fluid "
                ...
                with Naruto for Tsunade whom he chooses to become Fifth Hokage instead.
                </p>
                <div class="row">
                    <div class="col-sm-6 col-xs-12">
                        <img class="mobil border border-5 border-dark rounded img-fluid"
                    ...
                    <div class="col-sm-6 col-xs-12 col-md-12">
                        ...
                        ninja, including Naruto, to retrieve Sasuke, but Naruto is unable to persuade or force him to come back.
                        Naruto and Sakura do not give up on Sasuke: Naruto leaves Konoha to receive training from Jiraiya to
                        prepare himself for the next time he encounters Sasuke, while Sakura becomes Tsunade's apprentice.
                        </p>
                    </div>
                </div>
            </div>
